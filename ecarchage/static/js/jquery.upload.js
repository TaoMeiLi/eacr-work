        ...
        upload: function (settings) {
            ...
            this.each(function () {
                ...
                $this.bind("click", function () {
                	//<input id="Filedata" runat="server" name="Filedata" type="file" style="opacity:0; filter:alpha(opacity=0); width: 98px;height:98px;">
                    var $fileInput = $(this).parent().find("input:file");
                  // alert($(this).parent().find("input:file").html());
                    var fileBox = $fileInput.parent();
                   
                    //alert(fileBox.html());return false;
                    if ($fileInput.val() === "") {
                        alert("请选择要上传的图片！");
                        return false;
                    }
                    ...
                    //fileBox.html('<input id="Filedata" runat="server" name="Filedata" type="file" style="opacity:0; filter:alpha(opacity=0); width: 98px;height:98px;">');
                    fileBox.html('<input id="Filedata" name="Filedata" type="file" class="upload-photo" accept="image/*" />');
                    //$this.attr("disabled", true);
                    //$form.append(fileBox.html());
                   // return false;
                    //构建ajaxSubmit参数
                    var data = {};
                    ...
                    data.success = function (response, statusText, xhr, $form) {
                        ...
                        if (response.MessageType==1 || response.code==2000) {
